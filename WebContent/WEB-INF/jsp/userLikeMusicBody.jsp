...
<body>
	<div id="select_div">
		<form action="toUserLikeMusicBody.action" method="post">
				<a>搜索音乐</a>
	...
	<div style="overflow:hidden; width: 100% ;height:calc(100% - 80px);border-radius:6px;">
		...
		<div id="table_div">
			<table>
				<tbody id="td">
					<c:forEach items="${userLikeMusicList}" var="item" varStatus="index">
						<tr class="MusicTableTr" onmouseover="TrOnClick(this)">
							...
							<td style="width: 30%">${item.music_album}<a class="delLike" onclick="delLike('${item.music_id}','${item.music_name}')">🗑</a></td>
